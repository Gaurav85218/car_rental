...
const API_BASE_URL = 'https://car-rental-e9te.onrender.com/api'; // Update with your backend URL
...
export const authAPI = {
  ...
  resetPassword: (data) => api.post('/auth/reset-password', data),   // expects { token, newPassword }
};
